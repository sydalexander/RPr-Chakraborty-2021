...
However, we replace the missing data with zeros, which is necessary to run later statistical tests and the Kulldorff model.
...
Map the county level distribution of excess death incidence rates, comparing to Figure 1 of the original study.
...
## Compare COVID-19 incidene with excess deaths?
