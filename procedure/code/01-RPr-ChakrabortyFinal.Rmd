...
##NEW Excess Death COVID-19 data transformations - NO RUN?
...
```{r covid-rate, eval = FALSE}
death_table <- death %>%
  mutate(covid_rate = round(death$covid_deaths_2020 / death$all_cause_deaths_2020 * 100000, 2)) %>%
  st_drop_geometry()
```
...
tm_covid_rates <- tm_shape(death_table) +
