...
##NEW: Load Excess Mortality Data 2020
### Load COVID-19 data 
...
##NO-RUN??? NEW Excess Death COVID-19 data transformations
...
```{r edeath-rate, eval = FALSE}
death_table <- death %>%
  mutate(edeath_rate = round(death$excess_deaths_2020 / death$all_cause_deaths_2020 * 100000, 2)) %>%
  st_drop_geometry()
```
...
death_table <- select(death, cs_code.x, county_name, state_fips, county_fips, county_code,covid_death_rate_2020, excess_deaths_2020, excess_death_rate_2020)
...
tm_covid_rates <- tm_shape(acs_covid) +
  tm_polygons("excess_death_rate_2020",
    title = "Excess Death Cases per 100,000 people\n(March 2020 to 1 December 2020)",
    style = "quantile",
    border.alpha = .2,
    lwd = 0.2,
    palette = "Oranges",
