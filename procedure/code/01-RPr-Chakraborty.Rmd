...
#FIX - Missing Data
```{r missing data FIX}
#changed the Kable parameters in the original codeblock to improve the formatting of the table
# county with missing data
library(kableExtra)
...
### COVID-19 Incidence Map and Summary statistic Reproductions (EMILY)
...
### Visualization of COVID-19 Clusters from SaTScan
